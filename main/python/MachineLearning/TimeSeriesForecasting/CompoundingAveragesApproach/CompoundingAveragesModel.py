...
def model_step(data_test, data_train, print_summary_info=False):
    ...
    # prob_1, verdict_1, stag_1, incr_1, decr_1 = mill_avgerage(data_train, length, 0.99, print_detailed_info)
    prob_5, verdict_5, stag_5, incr_5, decr_5 = mill_avgerage(data_train, length, 0.95, print_detailed_info)
    prob_10, verdict_10, stag_10, incr_10, decr_10 = mill_avgerage(data_train, length, 0.90, print_detailed_info)
    prob_20, verdict_20, stag_20, incr_20, decr_20 = mill_avgerage(data_train, length, 0.80, print_detailed_info)
    prob_33, verdict_33, stag_33, incr_33, decr_33 = mill_avgerage(data_train, length, 0.67, print_detailed_info)
    # prob_50, verdict_50, stag_50, incr_50, decr_50 = mill_avgerage(data_train, length, 0.50, print_detailed_info)
    # prob_100, verdict_100, stag_100, incr_100, decr_100 = mill_avgerage(data_train, length, 0.00, print_detailed_info)
    ...
    prob_stagnate = (stag_5 + stag_10 + stag_20 + stag_33) / 4
    # prob_increase = (incr_5 + incr_10 + incr_20 + incr_33 + incr_50 + incr_100) / 6
    prob_increase = (incr_5 + incr_10 + incr_20 + incr_33) / 4
    # prob_decrease = (decr_5 + decr_10 + decr_20 + decr_33 + decr_50 + decr_100) / 6
    prob_decrease = (decr_5 + decr_10 + decr_20 + decr_33) / 4
